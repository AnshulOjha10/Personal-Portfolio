...
function Work() {
  return (
    ...
    >
      ...
      >
        Here are some of the projects I’ve built, showcasing my skills in both
        frontend and backend development. I enjoy working across the MERN stack
        to create dynamic, responsive, and scalable web applications.
      </motion.p>
